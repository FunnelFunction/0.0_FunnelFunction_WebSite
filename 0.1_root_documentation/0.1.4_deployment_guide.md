...
|-----------|----------|-----|
| Main Site | GitHub Pages | `https://funnelfunction.github.io/` |
| Campaign Commander | GitHub Pages | `https://funnelfunction.github.io/simulators/campaign-commander/` |
| Gating Function Lab | GitHub Pages | `https://funnelfunction.github.io/simulators/gating-function-lab/` |
| Blog/Whitepapers | WordPress | `https://funnelfunction.com/` |
| Social Hub | GitHub Pages | `https://funnelfunction.github.io/social/` |
...
- Main site: `https://funnelfunction.github.io/`
- Campaign Commander: `https://funnelfunction.github.io/simulators/campaign-commander/`
- Gating Function Lab: `https://funnelfunction.github.io/simulators/gating-function-lab/`
...
export default defineConfig({
  plugins: [react()],
  base: '/simulators/campaign-commander/',  // Important for GitHub Pages
  build: {
    outDir: 'dist',
    sourcemap: true,
  },
...
export default defineConfig({
  plugins: [react()],
  base: '/simulators/gating-function-lab/',  // Important for GitHub Pages
  build: {
    outDir: 'dist',
    sourcemap: true,
  },
